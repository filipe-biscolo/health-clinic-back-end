...
routes.get(
  "/professionals/all",
  authMiddleware,
  ProfessionalController.indexAll
);
...
routes.get(
  "/professionals/:id/hi",
  authMiddleware,
  ProfessionalController.indexHI
);
routes.post(
  "/professionals/hi",
  authMiddleware,
  ProfessionalController.createHI
);
routes.delete(
  "/professionals/hi/:id",
  authMiddleware,
  ProfessionalController.deleteHI
);
...
routes.get(
  "/health-insurances",
  authMiddleware,
  HealthInsuranceController.index
);
routes.get(
  "/health-insurances/all",
  authMiddleware,
  HealthInsuranceController.indexAll
);
routes.get(
  "/health-insurances/:id",
  authMiddleware,
  HealthInsuranceController.show
);
routes.post(
  "/health-insurances",
  authMiddleware,
...
routes.delete(
  "/health-insurances/:id",
  authMiddleware,
  HealthInsuranceController.delete
);
...
routes.get("/attendances", authMiddleware, ScheduleController.index);
routes.get("/attendances/:id", authMiddleware, ScheduleController.show);
routes.post("/attendances", authMiddleware, AttendanceController.create);
routes.put("/attendances/:id", authMiddleware, ScheduleController.update);
